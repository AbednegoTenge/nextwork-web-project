...
<body class="bg-[#050505] text-[#e5e5e5] font-sans antialiased overflow-x-hidden">
                ...
                <div class="lg:col-span-4 animate-fade-in-up delay-400" style="opacity:0">
                    <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg overflow-hidden">
                        ...
                        <div class="p-5 font-mono text-sm space-y-2">
                            ...
                            <p class="text-neutral-300">&rarr; backend_dev / devops_enthusiast</p>
                            <p class="text-green-400 mt-3">$ cat stack.txt</p>
                            <p class="text-neutral-300">&rarr; Django &middot; Python &middot; AWS</p>
                            <p class="text-neutral-300">&rarr; Docker &middot; CI/CD &middot; Terraform</p>
                            <p class="text-green-400 mt-3">$ aws sts get-caller-identity</p>
                            <p class="text-neutral-300">&rarr; "Cloud Practitioner &#10003;"</p>
                            <p class="text-green-400 mt-3">$ echo $GOAL</p>
                            <p class="text-neutral-300">&rarr; "Solutions Architect Associate"</p>
        ...
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                <div class="lg:col-span-4">
                    <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">01 &mdash; About</span>
                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <p class="text-lg md:text-xl font-light text-neutral-400 leading-relaxed">
                        My goal is simple: bridge the gap between development and operations. I believe great software deserves great infrastructure &mdash; and I&#39;m building the skills to deliver both.
                    </p>
    ...
    <section id="skills" class="py-24 md:py-32 border-t border-neutral-800">
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="mb-16">
                <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">02 &mdash; Skills</span>
    ...
    <section id="certifications" class="py-24 md:py-32 border-t border-neutral-800">
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="mb-16">
                <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">03 &mdash; Certifications</span>
    ...
    <section id="projects" class="py-24 md:py-32 border-t border-neutral-800">
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="flex items-end justify-between mb-16">
                <div>
                    <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">04 &mdash; Projects</span>
                    ...
                    <a href="#" class="block">
                        <div class="project-visual aspect-[4/3] rounded-lg mb-6 bg-neutral-900/80 border border-neutral-800 p-6 flex items-center justify-center overflow-hidden transition-all duration-500">
                            <svg viewBox="0 0 440 260" class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <text x="285" y="90" text-anchor="middle" fill="#525252" font-size="6" font-family="Inter">Worker x 2</text>
    ...
    <section id="labs" class="py-24 md:py-32 border-t border-neutral-800">
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="mb-16">
                <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">05 &mdash; Hands-On Labs</span>
                <h2 class="font-display font-medium text-4xl md:text-5xl tracking-tight leading-tight">AWS Lab Experience</h2>
                <p class="text-lg font-light text-neutral-400 mt-4 max-w-2xl">Extensive hands-on practice designing, building, and troubleshooting AWS architectures &mdash; going far beyond theoretical knowledge.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-blue-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-blue-400" data-icon="lucide:network" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">VPC Design &amp; Subnetting</h4><p class="text-xs text-neutral-500">Custom VPCs with public/private subnets, NAT Gateways, NACLs, and route tables</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-green-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-green-400" data-icon="lucide:layers" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Multi-Tier Architecture</h4><p class="text-xs text-neutral-500">Web/App/DB tiers with ALB, Auto Scaling Groups, and RDS Multi-AZ</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-purple-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-purple-400" data-icon="lucide:shield" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Security &amp; IAM</h4><p class="text-xs text-neutral-500">Least privilege IAM policies, roles, KMS encryption, and security groups</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-orange-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-orange-400" data-icon="lucide:zap" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Serverless Patterns</h4><p class="text-xs text-neutral-500">Lambda, API Gateway, DynamoDB, Step Functions, and EventBridge</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-red-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-red-400" data-icon="lucide:rotate-ccw" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Disaster Recovery</h4><p class="text-xs text-neutral-500">Multi-region replication, Route 53 failover, backup/restore strategies</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-cyan-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-cyan-400" data-icon="lucide:container" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Container Orchestration</h4><p class="text-xs text-neutral-500">ECS Fargate, ECR, EKS basics, and Docker on AWS deployment</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-yellow-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-yellow-400" data-icon="lucide:database" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Database &amp; Caching</h4><p class="text-xs text-neutral-500">RDS, Aurora, DynamoDB, ElastiCache Redis, and read replicas</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-pink-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-pink-400" data-icon="lucide:git-branch" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Hybrid &amp; Connectivity</h4><p class="text-xs text-neutral-500">VPN, Direct Connect, VPC Peering, Transit Gateway, and endpoint services</p></div>
                    </div>
                </div>
                <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-5 hover:border-neutral-700 hover:bg-neutral-900/80 transition-all duration-300">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded bg-emerald-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="iconify text-emerald-400" data-icon="lucide:bar-chart-3" data-width="16"></span></div>
                        <div><h4 class="font-medium text-sm mb-1">Cost Optimization</h4><p class="text-xs text-neutral-500">Reserved Instances, Spot Fleets, Cost Explorer, and rightsizing strategies</p></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 md:py-32 border-t border-neutral-800">
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="text-center mb-16">
                <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">06 &mdash; Architecture</span>
                <h2 class="font-display font-medium text-4xl md:text-5xl tracking-tight leading-tight">Sample Cloud Architecture</h2>
                <p class="text-lg font-light text-neutral-400 mt-4 max-w-xl mx-auto">A typical production-grade architecture I design &mdash; high availability, scalable, and secure.</p>
            </div>
            <div class="bg-neutral-900/50 border border-neutral-800 rounded-lg p-8 md:p-12 overflow-x-auto">
                <svg viewBox="0 0 900 500" class="w-full min-w-[700px]" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="450" y="155" text-anchor="middle" fill="#22d3ee" font-size="11" font-family="Inter">CloudFront (CDN)</text>
                    ...
                    <text x="450" y="220" text-anchor="middle" fill="#f59e0b" font-size="11" font-family="Inter">Application Load Balancer</text>
                    ...
                    <text x="680" y="385" text-anchor="middle" fill="#3b82f6" font-size="11" font-family="Inter">RDS PostgreSQL</text>
        ...
        <div class="max-w-screen-2xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div class="lg:col-span-5">
                    <span class="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4 block">07 &mdash; Contact</span>
                    ...
                    <p class="text-lg font-light text-neutral-400 leading-relaxed mb-8">
                        Whether you need a backend built, cloud architecture designed, or DevOps pipelines automated &mdash; I&#39;m ready to contribute.
                    </p>
                    <div class="space-y-4">
    ...
    <footer class="border-t border-neutral-800 py-12">
        <div class="max-w-screen-2xl mx-auto px-6">
            ...
            <div class="mt-12 pt-8 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-xs text-neutral-600">&copy; 2024 &mdash; Designed &amp; built with Django mindset</p>
                <p class="text-xs text-neutral-600">Infrastructure as Code &bull; Everything Automated</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        document.querySelectorAll('#skills .group').forEach(function(card) {
            skillObserver.observe(card);
        });
        document.querySelectorAll('.skill-bar').forEach(function(bar) { bar.style.width = '0%'; });
